...
import DiningEtiquetteImage from "../../assets/ch9/dining_etiquette.jpg";

// New images added
import TableMannersImg from "../../assets/ch9/table_manners.jpg";
import PlaceSettingsImg from "../../assets/ch9/Place_settings.jpg";
import BreadDrinksImg from "../../assets/ch9/Bread_drinks.jpg";
import NapkinImg from "../../assets/ch9/Napkin.jpg";
import SoupImg from "../../assets/ch9/Soup.jpg";
import HoldingImg from "../../assets/ch9/Holding.jpg";
import CutlerySignalsImg from "../../assets/ch9/cutlery_signals.jpg";
import ThankuImg from "../../assets/ch9/Thanku.jpg";

// Updated Chips with unique pastel colors
const chips = [
  { label: "Why table manners", wrap: "border-emerald-200 bg-emerald-50 text-emerald-900", dot: "bg-emerald-500" },
  { label: "Place settings", wrap: "border-cyan-200 bg-cyan-50 text-cyan-900", dot: "bg-cyan-500" },
  { label: "Bread & drinks", wrap: "border-amber-200 bg-amber-50 text-amber-900", dot: "bg-amber-500" },
  { label: "Napkins & soup", wrap: "border-rose-200 bg-rose-50 text-rose-900", dot: "bg-rose-500" },
  { label: "Cutlery styles", wrap: "border-violet-200 bg-violet-50 text-violet-900", dot: "bg-violet-500" },
  { label: "Do & Don’t at table", wrap: "border-indigo-200 bg-indigo-50 text-indigo-900", dot: "bg-indigo-500" },
  { label: "Thank-you notes", wrap: "border-teal-200 bg-teal-50 text-teal-900", dot: "bg-teal-500" },
  { label: "Self-reflection", wrap: "border-sky-200 bg-sky-50 text-sky-900", dot: "bg-sky-500" },
];

// Chip Component
function Chip({ label, wrap, dot }) {
  return (
    <span className={`inline-flex items-center gap-2 rounded-full border px-3 py-1 text-sm font-medium ${wrap}`}>
...
// SectionCard (Hover effect + spacing added)
function SectionCard({ title, tone = "emerald", children }) {
  ...
  return (
    <div
      className={`rounded-2xl border ${t.wrap} p-5 md:p-6 mb-6 transition duration-300 transform hover:shadow-xl hover:-translate-y-1 hover:scale-[1.01]`}
    >
        ...
        <div className="relative bg-white bg-opacity-95 rounded-3xl shadow-2xl px-4 py-8 md:px-8 md:py-10">
          ...
          <div className="grid md:grid-cols-2 gap-4 my-6">
            ...
            <SectionCard tone="emerald" title="Place settings – where do I begin?">
              ...
              <ul className="list-disc pl-5 space-y-1 text-sm">
                ...
                <li>The salad fork is usually the outer fork on the left (in US style) because salad often comes first.</li>
                <li>A charger or place plate is mainly decorative and protects the tablecloth from food drops.</li>
              </ul>
            </SectionCard>
            ...
            <SectionCard tone="slate" title="Bread & drinks – easy memory trick">
              ...
              <ul className="list-disc pl-5 space-y-1 text-sm">
                ...
                <li><span className="font-semibold">b = bread</span> (left side), <span className="font-semibold">d = drink</span> (right side).</li>
                <li>Break bread or rolls into small pieces and butter only the piece you are eating.</li>
                <li>Salt and pepper are “a couple” – always pass them together, held at the base of the shakers.</li>
              </ul>
            </SectionCard>
          ...
          <div className="grid md:grid-cols-2 gap-4 my-6">
            ...
            <SectionCard tone="amber" title="Napkin rules">
              ...
              <ul className="list-disc pl-5 space-y-1 text-sm">
                <li>After sitting, wait for the host to place their napkin, then place yours on your lap (folded, not crumpled).</li>
                <li>In informal meals, put your napkin neatly to the left of your plate when you leave the table; in formal settings, place it on your chair.</li>
            ...
            <SectionCard tone="cyan" title="Soup and small rules">
              ...
              <ul className="list-disc pl-5 space-y-1 text-sm">
                ...
                <li>Only drink soup from the cup if it is served in a small cup and only clear broth is left.</li>
                <li>When finished, place the spoon on the plate under the bowl, not inside the empty bowl.</li>
                <li>Lemon in tea: use one hand to squeeze and the other hand to shield so juice does not spray others.</li>
              </ul>
            </SectionCard>
          ...
          <SectionCard tone="emerald" title="Holding and using cutlery">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div>
                ...
                <ul className="list-disc pl-5 space-y-1 text-sm">
                  <li><span className="font-semibold">Scalpel method</span> – hold the knife/fork like a surgeon’s scalpel, tines facing down.</li>
                  <li><span className="font-semibold">Pencil method</span> – like holding a pencil, resting between fingers.</li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="list-disc pl-5 space-y-1 text-sm">
                  <li><span className="font-semibold">Continental / European style:</span> cut food and keep fork in left, knife in right; eat with fork tines down.</li>
                  <li><span className="font-semibold">American style:</span> cut food, place knife down, switch fork to right hand and eat with tines up.</li>
                </ul>
              </div>
            </div>
          </SectionCard>

          {/* Good practice and avoid */}
          <div className="grid md:grid-cols-2 gap-4 my-6">

            <SectionCard tone="slate" title="Good practice at the table">
              <ul className="list-disc pl-5 space-y-1 text-sm">
                <li>Pass food, condiments, salt and pepper to the right (unless the person asking is on your left).</li>
                <li>If you find hair or a foreign object in your food, quietly inform the server and request a new plate.</li>
                <li>If service is poor, speak to the manager rather than scolding the server.</li>
                <li>If you burp or sneeze, do it as quietly as possible, cover your mouth and turn slightly away. Do not make a big scene.</li>
                <li>If someone else makes a mistake, ignore it instead of correcting them in front of others.</li>
              </ul>
            </SectionCard>

            <SectionCard tone="amber" title="Things to avoid (based on the quiz)">
              <ul className="list-disc pl-5 space-y-1 text-sm">
                <li>Do not put used knives back on the tablecloth – rest them on the plate.</li>
                <li>Do not pick your teeth at the table or ask for a toothpick in front of everyone; go to the restroom.</li>
                <li>Do not crawl under the table to collect dropped cutlery; ask the server for a clean one.</li>
                <li>Do not rearrange place cards – the host has planned the seating.</li>
                <li>Do not leave early when you finish eating; wait until the host ends the meal.</li>
              </ul>
            </SectionCard>

          </div>

          {/* Finished signals & Thank you notes */}
          <div className="grid md:grid-cols-2 gap-4 my-6">

            <SectionCard tone="cyan" title="Finished or still eating? – cutlery signals">
              <img
                src={CutlerySignalsImg}
                alt="Cutlery signals"
                className="rounded-xl mb-4 w-full h-40 object-cover shadow-md"
              />
